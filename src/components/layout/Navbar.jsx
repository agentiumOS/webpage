    ...
    <header className={`fixed top-0 z-50 w-full transition-all duration-300 ${scrolled ? 'border-b border-white/10 bg-slate-950/75 py-3 shadow-[0_18px_60px_rgba(2,6,23,0.45)] backdrop-blur-xl' : 'bg-transparent py-5'}`}>
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-400">
          ...
          <a href="https://docs.agentium.in" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 transition-colors hover:text-white">
            Docs
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="https://docs.agentium.in" target="_blank" rel="noopener noreferrer" className="hidden rounded-full bg-white px-4 py-2 text-sm font-bold text-slate-950 transition hover:bg-slate-200 sm:inline-flex">
            Get Started
          </a>
          <button
      ...
      {mobileOpen && (
        <div className="border-t border-white/10 bg-slate-950/95 backdrop-blur-xl md:hidden">
          <div className="container mx-auto px-6 py-4 flex flex-col gap-3">
            ...
            <a href="https://docs.agentium.in" target="_blank" rel="noopener noreferrer" className="py-2 text-sm font-medium text-slate-300 hover:text-white">Docs</a>
            <a href="https://docs.agentium.in" target="_blank" rel="noopener noreferrer" className="mt-2 rounded-full bg-white px-4 py-2 text-center text-sm font-bold text-slate-950">Get Started</a>
          </div>
        </div>
      )}
    </header>
