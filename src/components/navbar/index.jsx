...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ease-in-out mt-5 max-w-7xl mx-auto px-4 sm:px-6 lg:px-0 rounded-full
        outline outline-0 outline-offset-0 outline-gray-100 py-1
        ${showNavbar ? 'translate-y-0' : '-translate-y-full -mt-5 '} 
